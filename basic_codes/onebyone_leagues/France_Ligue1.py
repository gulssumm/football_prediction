...
url_file = "../basic_codes/URLS/urls_FR_ligue1.txt"
...
df.to_csv('2000_24_FR_Ligue1.csv', index=False)

print("Data scraping complete. Results saved to 2000_24_FR_Ligue1.csv")
