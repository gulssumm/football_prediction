...
url_file = "../basic_codes/URLS/urls_IT_serieA.txt"
...
df.to_csv('2000_24_IT_serieA.csv', index=False)

print("Data scraping complete. Results saved to 2000_24_IT_serieA.csv")
