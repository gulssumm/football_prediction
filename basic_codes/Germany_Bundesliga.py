...
url_file = "../basic_codes/URLS/urls_GER_Bundesliga.txt"
...
df.to_csv('2000_24_GER_Bundesliga.csv', index=False)

print("Data scraping complete. Results saved to 2000_24_GER_Bundesliga.csv")
